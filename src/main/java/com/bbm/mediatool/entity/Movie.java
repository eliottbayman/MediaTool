...
public class Movie {
	 ...
	 * stack:/Volumes/UNTITLED/COLLECTIONS/Lord of the Rings (3)/The Lord of the Rings -- The Fellowship of the Ring (Extended Edition)/Lord of the Rings - The Fellowship of the Ring CD1.avi , /Volumes/UNTITLED/COLLECTIONS/Lord of the Rings (3)/The Lord of the Rings -- The Fellowship of the Ring (Extended Edition)/Lord of the Rings - The Fellowship of the Ring CD2.avi , /Volumes/UNTITLED/COLLECTIONS/Lord of the Rings (3)/The Lord of the Rings -- The Fellowship of the Ring (Extended Edition)/Lord of the Rings - The Fellowship of the Ring CD3.avi
	*	
	 * @param fileStr
	 */
...
//				System.out.println("<<<"+buf);
				...
				if (i < 0) {
					...
					/* Hack to fix cases where double commas get into the file name of subsequent files */
					if (s.contains(",,")) {
						String hackedStr = s.replace(",,", ",");
						files.add(new File(hackedStr));
						System.out.println("hacked:"+hackedStr);
					} else {
						files.add(new File(s));
					}
				}
...
//		String t2 = "stack:///Users/mdaniel/Desktop/Weight of Water, The/The.Weight.of.Water-AC3.CD1.avi , /Volumes/P-PARTOUT D/MOVIES FROM KRILL/Weight of Water,, The/The.Weight.of.Water-AC3.CD2.avi";
